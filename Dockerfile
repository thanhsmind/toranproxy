...
&& sed -e "s/^allow_url_fopen .*$/allow_url_fopen = On/g" -i /etc/php_origin/5.6/cli/php.ini \
&& sed -e "s/^allow_url_include .*$/allow_url_include = On/g" -i /etc/php_origin/5.6/cli/php.ini \
